...
dnf install gnome-desktop3.x86_64 gdm terminator zsh vim ansible firefox evolution xclip gnome-tweaks.noarch libXScrnSaver libvpx SDL2 -y && dnf remove gnome-terminal rhythmbox totem cheese polari inkscape brasero gnome-dictionary gnome-user-guide gnome-packagekit empathy yelp gnome-weather gnome-contacts gnome-software gnome-online-miners tracker gnome-calculator vino tigervnc -y && dnf clean all
