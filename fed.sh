...
dnf install gnome-desktop3.x86_64 --excludepkg gnome-terminal rhythmbox totem cheese polari inkscape brasero gnome-dictionary gnome-user-guide gnome-packagekit empathy yelp gnome-weather gnome-contacts gnome-software gnome-online-miners gnome-sushi tracker gnome-calculator gnome-sushi vino
